...
function  initEvent() {
    ...
    $(window).resize(function () {
        ...
        var right =Math.floor(documentWidth - $(".center-box").width() - $('.center-box').offset().left);
        if (documentWidth >= 990) {
            $('#sidebar-checkbox').prop("checked", false);
        }
        $('.header-inner').css('right', right);
    });
    ...
    $(document).ready(function () {
        ...
        var right =Math.floor($(document).width() - $(".center-box").width() - $('.center-box').offset().left);
        $('.header-inner').css('right', right);
    });
